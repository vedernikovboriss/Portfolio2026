...
import { SOCIAL_LINKS } from "@/app/data/siteLinks";
    ...
    <section className="section-base relative z-10 flex flex-col gap-12 md:gap-16">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between lg:grid gap-4 lg:grid-cols-3 lg:gap-8">
          ...
          <span className="subtitle-small hidden lg:block">More Work</span>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
        <p className="lg:col-start-2">
          ...
          to see more details. For more details, check out my{" "}
          <Link
      ...
      <div className="flex flex-col gap-0">
        <div className="hidden grid-cols-6 gap-8 stroke-b pb-8 tracking-wider lg:grid">
