...
const HeroSection = () => {
  return (
    <section className="relative isolate flex min-h-svh flex-col justify-between gap-6 px-4 lg:px-[2vw] pb-8 pt-24 sm:gap-8 sm:pb-[2vw] sm:pt-28 md:pt-32 lg:pt-36">
